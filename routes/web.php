...
Route::get('/data-mahasiswa/{nim}', [
    MahasiswaController::class,
    'show'
])->name('mahasiswa.show-lama');

Route::get('/cari-mahasiswa', [
    MahasiswaController::class,
    'cari'
])->name('mahasiswa.cari');
...
// MAHASISWA WEB (Modul 3 - Eloquent)
Route::get(
    '/mahasiswa-data',
    [MahasiswaWebController::class, 'index']
)->name('mahasiswa.data');

Route::post(
    '/mahasiswa-data',
    [MahasiswaWebController::class, 'store']
)->name('mahasiswa.store');

Route::get(
    '/mahasiswa-data/{nim}',
    [MahasiswaWebController::class, 'show']
)->name('mahasiswa.show');

// Tugas 4: sepuluh mahasiswa IPK tertinggi pada program studi Teknik Komputer
Route::get(
    '/mahasiswa-ipk-tertinggi',
    [MahasiswaWebController::class, 'ipkTertinggi']
